...
def main():
    ...
    if args.finetune:
        ...
        prediction_df = func_run_evaluate.predict_func(processed_df, args.methyl_type, args.prediction_output_dir, args.finetuned_output_dir, args.labelled, args.multi_species, args.species)
